...
wolfssl_build:
	mkdir -p lib/wolfssl/
	make clean -C wolfssl
	cd wolfssl/ && ./configure --host=arm-none-eabi CC=arm-none-eabi-gcc AR=arm-none-eabi-ar STRIP=arm-none-eabi-strip RANLIB=arm-none-eabi-ranlib --target=arm-none-eabi --enable-singlethreaded --enable-smallstack --disable-examples --prefix=$(ROOT_DIR)lib/wolfssl --disable-crypttests --enable-fastmath --enable-ecc --enable-psk --enable-dtls CFLAGS="-mcpu=cortex-m7 -mthumb -mfpu=fpv5-sp-d16 -mfloat-abi=hard -nostartfiles -DNO_FILESYSTEM -DHAVE_PK_CALLBACKS -DNO_MAIN_DRIVER -DWOLFSSL_USER_IO -DNO_WRITEV -DTIME_T_NOT_64BIT"
	make -C wolfssl/
	make install -C wolfssl/

# OLD: ./configure --host=arm-non-eabi CC=arm-none-eabi-gcc AR=arm-none-eabi-ar STRIP=arm-none-eabi-strip RANLIB=arm-none-eabi-ranlib --prefix=$(ROOT_DIR)lib/wolfssl CFLAGS="-march=armv8-a --specs=nosys.specs -DHAVE_PK_CALLBACKS -DWOLFSSL_USER_IO -DNO_WRITEV -DTIME_T_NOT_64BIT" --disable-filesystem --enable-fastmath --disable-shared
#NEW: ./configure --host=arm-non-eabi CC=arm-none-eabi-gcc AR=arm-none-eabi-ar STRIP=arm-none-eabi-strip RANLIB=arm-none-eabi-ranlib --prefix=$(ROOT_DIR)lib/wolfssl CFLAGS="-mcpu=cortex-m7 --specs=rdimon.specs -mfpu=fpv5-d16 -mfloat-abi=hard -DHAVE_PK_CALLBACKS -DWOLFSSL_USER_IO -DNO_WRITEV -DTIME_T_NOT_64BIT" --disable-filesystem --enable-fastmath --disable-shared
# NEW CHATGPT: ./configure --host=arm-none-eabi --target=arm-none-eabi --enable-singlethreaded --enable-smallstack --disable-examples --disable-crypttests --enable-fips=v2 --enable-fastmath --enable-ecc --enable-psk --enable-dtls CFLAGS="-mcpu=cortex-m7 -mthumb -mfpu=fpv5-sp-d16 -mfloat-abi=hard -nostartfiles -DNO_FILESYSTEM -DNO_WRITEV -DNO_MAIN_DRIVER -DUSE_FAST_MATH -DHAVE_ECC -DARM_MATH_CM7 -DWOLFSSL_USER_SETTINGS"
# MODIF CHATGPT: ./configure --host=arm-none-eabi CC=arm-none-eabi-gcc AR=arm-none-eabi-ar STRIP=arm-none-eabi-strip RANLIB=arm-none-eabi-ranlib --target=arm-none-eabi --enable-singlethreaded --enable-smallstack --disable-examples --prefix=$(ROOT_DIR)lib/wolfssl --disable-crypttests --enable-fastmath --enable-ecc --enable-psk --enable-dtls CFLAGS="-mcpu=cortex-m7 -mthumb -mfpu=fpv5-sp-d16 -mfloat-abi=hard -nostartfiles -DNO_FILESYSTEM -DHAVE_PK_CALLBACKS -DNO_MAIN_DRIVER -DWOLFSSL_USER_IO -DNO_WRITEV -DTIME_T_NOT_64BIT"
